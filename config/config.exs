...
config :petal, PetalWeb.Endpoint,
  ...
  live_view: [signing_salt: "QF1Tu4PV"]
...
config :surface, :components, [
  {Surface.Components.Form.ErrorTag, default_translator: {PetalWeb.ErrorHelpers, :translate_error}}
]

# Set languages
config :petal, PetalWeb.Gettext, default_locale: "de", locales: ~w(de en)
